...
function selectImageSource({ partType, role, imageRole, brandAssetAvailable, brandAssetLookupAvailable = false, brandAssetSuitable = true, sourceAsset = null, fallbackReason = null }) {
