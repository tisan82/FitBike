...
export async function getModelDetail(
  ...
  return {
    ...
    transmissionType: modelYear.transmission_type,
    maxPowerKw: modelYear.max_power_kw,
    maxPowerPs: modelYear.max_power_ps,
    maxPowerRpm: modelYear.max_power_rpm,
    maxTorqueNm: modelYear.max_torque_nm,
    maxTorqueRpm: modelYear.max_torque_rpm,
    lengthMm: modelYear.length_mm,
    widthMm: modelYear.width_mm,
    heightMm: modelYear.height_mm,
    wheelbaseMm: modelYear.wheelbase_mm,
    seatHeightMm: modelYear.seat_height_mm,
    curbWeightKg: modelYear.curb_weight_kg,
    fuelCapacityL: modelYear.fuel_capacity_l,
    priceMinKrw: modelYear.price_min_krw,
    priceMaxKrw: modelYear.price_max_krw,
    priceVerifiedAt: modelYear.price_verified_at,
    engineOilChangeL: modelYear.engine_oil_change_l,
    engineOilFilterChangeL: modelYear.engine_oil_filter_change_l,
    engineOilTotalL: modelYear.engine_oil_total_l,
    engineOilSae: modelYear.engine_oil_sae,
    engineOilApi: modelYear.engine_oil_api,
    engineOilJaso: modelYear.engine_oil_jaso,
